...
% 
% SYNTAX:
% performanceLDA = calcCumSum_DiffStartT_SingleChnHbX_NoSave(sbjNum,...
...
%   rLDA classifier using all 3 chromophores simultaneously. Test 
%   different decision windows over the duration of trial. 1 sec window 
%   length.
% 
% RESTRICTION:
% None.
