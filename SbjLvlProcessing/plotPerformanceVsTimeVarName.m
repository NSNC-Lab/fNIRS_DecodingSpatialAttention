...
function plotPerformanceVsTimeVarName(sbjNum,varName,fileName,fileDir,featureName,timePt)
...
for j = 1:size(varName,1)
    ...
    plot(timePt./fs-2,varName(j,:));
end
ylim([0 1]);
title(sprintf('Sbj %s: %s Single Movie',num2str(sbjNum),featureName));
