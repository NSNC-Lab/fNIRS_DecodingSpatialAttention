...
% 
% SYNTAX:
% preprocessFNIRS06_CV_GLM_ssBeta_SingleChn(s,numClasses,rejTrOp,rejChnOp)
% 
% DESCRIPTION:
...
function preprocessFNIRS06_CV_GLM_ssBeta_SingleChn(s,numClasses,rejTrOp,rejChnOp)
...
if numClasses == 2
    ...
    if rejTrOp
        fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_SingleChn_RejTr_SNR_1.5.mat'];
    else
