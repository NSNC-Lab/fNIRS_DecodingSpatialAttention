...
function plotPerformanceCumsum_MultiOnly(sbjNum,numClasses)
...
if numClasses == 2
    load([saveDir filesep 'performanceLinearDiscriminantUpdated_LR.mat'],'performanceArrMultiHbO',...
    ...
    load([saveDir filesep 'performanceLinearDiscriminantUpdated.mat'],'performanceArrMultiHbO',...
        'performanceArrMultiHbR',...
        'performanceArrMultiHbT',...
        'predRespMHbO','singleTrialHRFHbOM',...
        'singleTrialHRFHbRM',...
