...
%         0:1/50:(size(snirf1.data.dataTimeSeries,1)-1)/50,snirf1.data.measurementList);
    ...
    if numClasses == 2
        if rejTrOp
            %fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_LR_RejTr.mat'];
    ...
    if numClasses == 2
        if rejTrOp
            fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_LR_RejTr_10Hz.mat'];
        else
            fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_LR.mat'];
        end
    else
        if rejTrOp
            fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_RejTr.mat'];
        else
            fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta.mat'];
        end
    end
