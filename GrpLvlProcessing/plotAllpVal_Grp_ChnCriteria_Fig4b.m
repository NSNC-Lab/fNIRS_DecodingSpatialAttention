% Plot average p-val for each channel, and number of sbjs with p-val below
% critical value.
...
% Channel numbers include SS.
%
% Finalized channels for paper
% FEF S5D9, S4D9 (18, 12)
% and FEF S1D3, S3D3 (3, 8)
% 
% Below are other options
% FEF S2D1, S5D9 (5, 18)
% sPSC S1D3, S5D9 (3, 18)
% iPSC S3D6, S4D12 (11, 15)
% IPS3 S9D14, S10D15 (28, 31)
% IPS4/mSPL S11D14, S12D15 (34,36)
% STG S7D16 S8D17 (23, 25)

% top 5 channels based on HbT t=4s
% S8D17 posterior STG/PT R (25) (0.64 for high-performing grp) (0.64 for
% all grp)
% S5D8 posterior to sPCS/tgPSC R (17) (0.67 for high-performing grp) (0.61
% for all grp)
% S4D10 iPSC/tgPSC R (13) (0.63 for high-performing grp) (0.61 for all grp)
% S5D9 Middle FEF R (18) (0.64 for high-performing grp) (0.60 for all grp)
% S1D2 Posterior to sPCS/tgPSC L (2) (0.62 for high-performing grp) (0.59
% for all grp)
% S4D12 iPCS R (15)

% Their contralateral chn
% S7D16 0.5 for high-performing grp and 0.52 for all-grp
% S3D4 0.54 for high-performing grp and 0.54 for all-grp
% S1D3 0.49 for high-performing grp and 0.51 for all-grp
% 

% top channel from IPS
% S9D13 IPS3/IPS2/SPL1 L (27) (0.55 for high-performing grp) (0.56 for all grp).

% contralateral chn for IPS
% S10D13 0.45 for high-performing grp and 0.50 for all grp


function plotAllpVal_Grp_ChnCriteria_Fig4b(saveOp)

goodSbjList = {'08','12','13','16','19','21','24'};
badSbjList = {'14','15','22','23','25'};
fn = sprintf('PosteriorsPCS_tgPSC');
strGrp = 'All';
figSaveDir = 'C:\Users\mn0mn\Documents\ResearchProjects\spatailAttentionProject\ProcessedDatafNIRS\GroupResultAll\Figures\HRFs';
...
% this is channel number including SS
leftChnNum = 8;
leftStr = 'Left';
rightChnNum = 12;
rightStr = 'Right';
...
sgtitle(sprintf('Anterior FEF By Behavioral Performance'));
hold off;
