...
function plotPerformanceVsTimeAllChns_MultiOnly(sbjNum,fileName,fileDir,featureName)
...
load([fileDir filesep fileName],'performanceArrMultiHbO',...
...
ylim([0 1]);
title(sprintf('Sbj %s: Δ[HbO] %s ',num2str(sbjNum),featureName));
legend('HbO Multi','HbR Multi','HbT Multi');
xlabel('Time [s]');ylabel('Accuracy');
hold off;
