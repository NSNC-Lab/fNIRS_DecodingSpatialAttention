...
plotPerformanceBarChartROINames(sbjNum,performanceArrSingleHbO,tInd,'Cumulative Sum Δ[HbO] Single',1)
plotPerformanceBarChartROINames(sbjNum,performanceArrSingleHbR,tInd,'Cumulative Sum Δ[HbR] Single',1)
plotPerformanceBarChartROINames(sbjNum,performanceArrSingleHbT,tInd,'Cumulative Sum Δ[HbT] Single',1)
plotPerformanceBarChartROINames(sbjNum,performanceArrMultiHbO,tInd,'Cumulative Sum Δ[HbO] Multiple',1)
plotPerformanceBarChartROINames(sbjNum,performanceArrMultiHbR,tInd,'Cumulative Sum Δ[HbR] Multiple',1)
plotPerformanceBarChartROINames(sbjNum,performanceArrMultiHbT,tInd,'Cumulative Sum Δ[HbT] Multiple',1)
