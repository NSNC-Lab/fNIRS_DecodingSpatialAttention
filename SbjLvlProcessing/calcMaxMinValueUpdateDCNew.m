...
function calcMaxMinValueUpdateDCNew(sbjNum)
...
for i = 1:length(timePt)
    maxminValueHRFHbOS(:,1,:) = max(singleTrialHRFHbOS(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbOM(:,1,:) = max(singleTrialHRFHbOM(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbRS(:,1,:) = max(singleTrialHRFHbRS(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbRM(:,1,:) = max(singleTrialHRFHbRM(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbTS(:,1,:) = max(singleTrialHRFHbTS(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbTM(:,1,:) = max(singleTrialHRFHbTM(:,startT:timePt(i),:),[],2);
    
    maxminValueHRFHbOS(:,2,:) = min(singleTrialHRFHbOS(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbOM(:,2,:) = min(singleTrialHRFHbOM(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbRS(:,2,:) = min(singleTrialHRFHbRS(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbRM(:,2,:) = min(singleTrialHRFHbRM(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbTS(:,2,:) = min(singleTrialHRFHbTS(:,startT:timePt(i),:),[],2);
    maxminValueHRFHbTM(:,2,:) = min(singleTrialHRFHbTM(:,startT:timePt(i),:),[],2);

    [performanceArrSingleHbO(:,i),predRespSHbO(:,:,i)] = trainClassifierLinearDiscriminantfNIRS(maxminValueHRFHbOS,mlActAuto{1},numClasses,indexMoviesTestSingle);
    [performanceArrMultiHbO(:,i),predRespMHbO(:,:,i)] = trainClassifierLinearDiscriminantfNIRS(maxminValueHRFHbOM,mlActAuto{1},numClasses,indexMoviesTestMultiple);

    [performanceArrSingleHbR(:,i),predRespSHbR(:,:,i)] = trainClassifierLinearDiscriminantfNIRS(maxminValueHRFHbRS,mlActAuto{1},numClasses,indexMoviesTestSingle);
    [performanceArrMultiHbR(:,i),predRespMHbR(:,:,i)] = trainClassifierLinearDiscriminantfNIRS(maxminValueHRFHbRM,mlActAuto{1},numClasses,indexMoviesTestMultiple);

    [performanceArrSingleHbT(:,i),predRespSHbT(:,:,i)] = trainClassifierLinearDiscriminantfNIRS(maxminValueHRFHbTS,mlActAuto{1},numClasses,indexMoviesTestSingle);
    [performanceArrMultiHbT(:,i),predRespMHbT(:,:,i)] = trainClassifierLinearDiscriminantfNIRS(maxminValueHRFHbTM,mlActAuto{1},numClasses,indexMoviesTestMultiple);
...
plotPerformanceVsTime(sbjNum,savePerfFN,processedDataDir,'Max/Min')
