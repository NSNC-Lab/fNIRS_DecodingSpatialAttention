...
% 
% SYNTAX:
% preprocessFNIRS06_CV_GLM_ssBeta_MultiOnly_Peripheral(s,numClasses,...
...
function preprocessFNIRS06_CV_GLM_ssBeta_MultiOnly_Peripheral(s,numClasses,rejTrOp,rejChnOp,cond)
...
idxIPS = [27 28 30 31 33 34 35 36];
%idxRIPS = [30 31 35 36];
