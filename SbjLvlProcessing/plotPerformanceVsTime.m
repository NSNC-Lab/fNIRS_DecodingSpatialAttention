...
function plotPerformanceVsTime(sbjNum,fileName,fileDir,featureName)
...
ylim([0 1]);
title(sprintf('Sbj %s: Δ[HbO] %s Multi Movie',num2str(sbjNum),featureName));
%legend('S1D1','S1D2','S1D3','S1D4');
xlabel('Time [s]');ylabel('Accuracy');
hold off;
...
for j = 1:size(performanceArrSingleHbR,1)
    %plot(timePt./fs-2,performanceArrSingle(sizeChn*(j-1) + 1,:));
    plot(timePt./fs-2,performanceArrSingleHbR(j,:));
end
ylim([0 1]);
title(sprintf('Sbj %s: Δ[HbR] %s Single Movie',num2str(sbjNum),featureName));
%legend('S1D1','S1D2','S1D3','S1D4');
xlabel('Time [s]');ylabel('Accuracy');
hold off;
...
for j = 1:size(performanceArrMultiHbR,1)
    %plot(timePt./fs-2,performanceArrMulti(sizeChn*(j-1) + 1,:));
    plot(timePt./fs-2,performanceArrMultiHbR(j,:));
end
ylim([0 1]);
title(sprintf('Sbj %s: Δ[HbR] %s Multi Movie',num2str(sbjNum),featureName));
%legend('S1D1','S1D2','S1D3','S1D4');
xlabel('Time [s]');ylabel('Accuracy');
hold off;
...
for j = 1:size(performanceArrSingleHbT,1)
    %plot(timePt./fs-2,performanceArrSingle(sizeChn*(j-1) + 1,:));
    plot(timePt./fs-2,performanceArrSingleHbT(j,:));
end
ylim([0 1]);
title(sprintf('Sbj %s: Δ[HbT] %s Single Movie',num2str(sbjNum),featureName));
%legend('S1D1','S1D2','S1D3','S1D4');
xlabel('Time [s]');ylabel('Accuracy');
hold off;
...
for j = 1:size(performanceArrMultiHbT,1)
    %plot(timePt./fs-2,performanceArrMulti(sizeChn*(j-1) + 1,:));
    plot(timePt./fs-2,performanceArrMultiHbT(j,:));
end
ylim([0 1]);
title(sprintf('Sbj %s: Δ[HbT] %s Multi Movie',num2str(sbjNum),featureName));
%legend('S1D1','S1D2','S1D3','S1D4');
xlabel('Time [s]');ylabel('Accuracy');
hold off;
