...
% Use calcCumSum_AllBasis
% Test Different Classifiers
% Only use Gaussian Basis for HRF fitting.
% Add repts and CI. Used for publication

function plotCumSum_MultiOnly_DiffStartT_AllChn_CompClassifiers_Final(sbjNum,numClasses,saveOp)
