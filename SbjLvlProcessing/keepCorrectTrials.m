...
% trials var should have 90 trials
% Important, keep number of trials in trials and movieIdx the same
% for fNIRS only
% For sbj 08 and 10, use keepCorrectTrials_Special

function [trials,varargout] = keepCorrectTrials(sbjNum,trials,behFN,numClasses,movieIdx)
    ...
    multipleIndex = multipleIndex & (responsesA==correctRespA)' & (responsesV==correctRespV)';
