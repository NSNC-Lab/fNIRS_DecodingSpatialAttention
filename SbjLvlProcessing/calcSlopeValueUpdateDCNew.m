...
function calcSlopeValueUpdateDCNew(sbjNum,numClasses)
...
performanceArrSingleHbOR = zeros(size(singleTrialHRFHbOS,1),length(timePt));
performanceArrMultiHbOR = zeros(size(singleTrialHRFHbOS,1),length(timePt));
...
predRespSHbOR = zeros(size(singleTrialHRFHbTS,1),size(singleTrialHRFHbTS,3),length(timePt));
predRespMHbOR = zeros(size(singleTrialHRFHbTM,1),size(singleTrialHRFHbTM,3),length(timePt));
...
slopeValueHRFHbOS = zeros(size(singleTrialHRFHbOS,1),1,size(singleTrialHRFHbOS,3));
slopeValueHRFHbOM = zeros(size(singleTrialHRFHbOM,1),1,size(singleTrialHRFHbOM,3));
slopeValueHRFHbRS = zeros(size(singleTrialHRFHbRS,1),1,size(singleTrialHRFHbRS,3));
slopeValueHRFHbRM = zeros(size(singleTrialHRFHbRM,1),1,size(singleTrialHRFHbRM,3));
slopeValueHRFHbTS = zeros(size(singleTrialHRFHbTS,1),1,size(singleTrialHRFHbTS,3));
slopeValueHRFHbTM = zeros(size(singleTrialHRFHbTM,1),1,size(singleTrialHRFHbTM,3));

startT = 2*fs;

for i = 2:length(timePt)
    for j = 1:size(singleTrialHRFHbOS,1)
        for k = 1:size(singleTrialHRFHbOS,3)
            X = [ones(length(startT:timePt(i)),1) (startT:timePt(i))'];
            
            Beta = ((X'*X)\X')*squeeze(singleTrialHRFHbOS(j,startT:timePt(i),k))';
            slopeValueHRFHbOS(j,1,k) = Beta(2);
            
            Beta = ((X'*X)\X')*squeeze(singleTrialHRFHbOM(j,startT:timePt(i),k))';
            slopeValueHRFHbOM(j,1,k) = Beta(2);
            
            Beta = ((X'*X)\X')*squeeze(singleTrialHRFHbRS(j,startT:timePt(i),k))';
            slopeValueHRFHbRS(j,1,k) = Beta(2);
            
            Beta = ((X'*X)\X')*squeeze(singleTrialHRFHbRM(j,startT:timePt(i),k))';
            slopeValueHRFHbRM(j,1,k) = Beta(2);
            
            Beta = ((X'*X)\X')*squeeze(singleTrialHRFHbTS(j,startT:timePt(i),k))';
            slopeValueHRFHbTS(j,1,k) = Beta(2);
    ...
    [performanceArrMultiHbO(:,i),predRespMHbO(:,:,i)] = trainClassifierLinearDiscriminantfNIRS(slopeValueHRFHbOM,mlActAuto{1},numClasses,indexMoviesTestMultiple);
    ...
    [performanceArrMultiHbR(:,i),predRespMHbR(:,:,i)] = trainClassifierLinearDiscriminantfNIRS(slopeValueHRFHbRM,mlActAuto{1},numClasses,indexMoviesTestMultiple);
    ...
    [performanceArrMultiHbT(:,i),predRespMHbT(:,:,i)] = trainClassifierLinearDiscriminantfNIRS(slopeValueHRFHbTM,mlActAuto{1},numClasses,indexMoviesTestMultiple);
