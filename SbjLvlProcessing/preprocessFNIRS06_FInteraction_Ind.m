...
% 
% SYNTAX:
% preprocessFNIRS06_FInteraction_Ind(s,numClasses,rejTrOp,rejChnOp,...
%   rerunOp,plotOp)
% 
% DESCRIPTION:
...
function preprocessFNIRS06_FInteraction_Ind(s,numClasses,rejTrOp,rejChnOp,rerunOp,plotOp)
