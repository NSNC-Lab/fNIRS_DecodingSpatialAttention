...
function plotAllHRF_Grp_ChnCriteria_Fig3(saveOp)
...
if sigDiff(1,leftChnNum,1)
    LRMark = '*';
else
    LRMark = ' ';
end

if sigDiff(1,leftChnNum,2)
    LCMark = '+';
else
    LCMark = ' ';
end

if sigDiff(1,leftChnNum,3)
    RCMark = 'x';
else
    RCMark = ' ';
end
...
if sigDiff(2,leftChnNum,1)
    LRMark = '*';
else
    LRMark = ' ';
end

if sigDiff(2,leftChnNum,2)
    LCMark = '+';
else
    LCMark = ' ';
end

if sigDiff(2,leftChnNum,3)
    RCMark = 'x';
else
    RCMark = ' ';
end
...
if sigDiff(3,leftChnNum,1)
    LRMark = '*';
else
    LRMark = ' ';
end

if sigDiff(3,leftChnNum,2)
    LCMark = '+';
else
    LCMark = ' ';
end

if sigDiff(3,leftChnNum,3)
    RCMark = 'x';
else
    RCMark = ' ';
end
...
if sigDiff(1,rightChnNum,1)
    LRMark = '*';
else
    LRMark = ' ';
end

if sigDiff(1,rightChnNum,2)
    LCMark = '+';
else
    LCMark = ' ';
end

if sigDiff(1,rightChnNum,3)
    RCMark = 'x';
else
    RCMark = ' ';
end
...
if sigDiff(2,rightChnNum,1)
    LRMark = '*';
else
    LRMark = ' ';
end

if sigDiff(2,rightChnNum,2)
    LCMark = '+';
else
    LCMark = ' ';
end

if sigDiff(2,rightChnNum,3)
    RCMark = 'x';
else
    RCMark = ' ';
end
...
if sigDiff(3,rightChnNum,1)
    LRMark = '*';
else
    LRMark = ' ';
end

if sigDiff(3,rightChnNum,2)
    LCMark = '+';
else
    LCMark = ' ';
end

if sigDiff(3,rightChnNum,3)
    RCMark = 'x';
else
    RCMark = ' ';
end
