...
function calcCumSum_MultiOnly_DiffStartT_AllChn_CompClassifiers_Final(sbjNum,numClasses,saveOp)
...
[singleTrialHRFHbOM,mlList] = selectRS(singleTrialHRFHbOM,isSDNew,mlList);
