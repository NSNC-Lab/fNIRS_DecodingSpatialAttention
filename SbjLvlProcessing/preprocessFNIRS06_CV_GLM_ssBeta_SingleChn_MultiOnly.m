...
% 
% SYNTAX:
% preprocessFNIRS06_CV_GLM_ssBeta_SingleChn_MultiOnly(s,numClasses,...
%   rejTrOp,rejChnOp)
% 
% DESCRIPTION:
% Single channel classification but otherwise identical.
...
function preprocessFNIRS06_CV_GLM_ssBeta_SingleChn_MultiOnly(s,numClasses,rejTrOp,rejChnOp)
...
if numClasses == 2
    if rejTrOp
        %fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_SingleChn_LR_RejTr_SNR_1.5_OrigHomer3_10Hz.mat'];
        fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_SingleChn_LR_RejTr_SNR_1.5_OrigHomer3.mat'];
        %fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_LR_RejTr_SNR_1.5_NewHomer3.mat'];
    else
        fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_SingleChn_LR_SNR_1.5.mat'];
    end
else
    if rejTrOp
        fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_SingleChn_RejTr_SNR_1.5_10Hz.mat'];
    else
        fileName = [processedDataDir filesep 'performance_GLM_CV_SSBeta_SingleChn_SNR_1.5.mat'];
    end
end
