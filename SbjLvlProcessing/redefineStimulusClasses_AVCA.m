...
function redefineStimulusClasses_AVCA()

dir = ['C:\Users\mn0mn\Documents\ResearchProjects\spatailAttentionProject\GroupCA_20220114\GrpAsSbj'];
respData = 'iniList_wof_2022427_';
load([dir filesep respData '.mat'],'fixedMaskerList','indexMoviesTest','maskerMovies','numTrials','uniqueMovies');

rawDataFN = {'20220427_1251_03'};
