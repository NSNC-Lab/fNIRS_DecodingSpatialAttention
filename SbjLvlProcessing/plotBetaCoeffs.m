% plot average of coefficients across all subjects for each channel
% divide subplot into different conditions
...
% separate figure by chromophore
figure();
% separate subplot by channel, just averge coefficients across different
% conditions.
